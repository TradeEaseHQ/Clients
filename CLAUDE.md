...
- Lead quality threshold: only build demos for businesses with lead_quality_score >= 40
...
- **feature_only** — site score ≥ 75, pitch bundle features + two-offer (upgrade OR add-on)
